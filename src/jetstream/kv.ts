...
import { headers } from "../nats-base-client/headers";
import {
  consumerOpts,
  DirectStreamAPI,
  JetStreamClient,
...
import { compare, Feature, parseSemVer } from "../nats-base-client/semver";
import { deferred, millis, nanos } from "../nats-base-client/util";
...
import { JetStreamClientImpl, PubHeaders } from "./jsclient";
